...
\end{innerlist} 
\item[$\bullet$] Referee/reviewer/editor for scientific journals, books, and funding agencies:
\begin{innerlist}
...
\item \textbf{\textit{Exact trapped $N$-soliton solutions of the nonlinear Schr\"odinger equation
using the inverse problem method}}\\
F. Cooper, A. Khare, J. Dawson, E.G. Charalampidis and A. Saxena \\
\href{https://arxiv.org/abs/2309.08789}{arXiv:2309.08789} (submitted to Chaos)
...
\href{https://arxiv.org/abs/2306.08072}{arXiv:2306.08072} (to appear in Physica Scripta)
...
\item
\vskip  -6.5mm
AMS Fall Southeastern Sectional Meeting, Georgia Southern University, Savannah, GA, October 5 - 6, 2024.
...
Talk title: ``\textit{Numerical bifurcation analysis of self-similar collapse to nonlinear dispersive equations}''
