...
\begin{innerlist}
\item[$\triangleright$] ``Undergraduate Research in Nonlinear Waves, % 
Mathematical Biology, and Data Science: Theory and Computation'', amount: $\$291,210$ (submitted)
% \item[$\triangleright$] Collaborative Grant: %
% ``From Collapse to Rogue Waves and Beyond: %
% A Series of Current Challenges in Nonlinear Waves'', 
% amount: $\$141,090$ (submitted)
\end{innerlist}
\item[$\bullet$]
...
\item[$\triangleright$] MATH 241 - Calculus IV (F21)
...
\item[$\triangleright$] MATH 233 - Multivariable Calculus (F16)
% \item[$\triangleright$] MATH 456 - Mathematical Modeling, Fall 2018
...
\begin{innerlist}
\item[$\star$] September 2020 - June 2021: Marisa Lee\\
...
\item[$\triangleright$] Co-organizer (with P.~Kevrekidis and R.~Carretero) of 
...
\item[$\triangleright$] Co-organizer (with D.~Mantzavinos) of 
                        the special session on ``Nonlinear Waves: Analysis \& Computation'', 
                        The 12th IMACS International Conference on Nonlinear Evolution Equations and Wave Phenomena: 
                        Computation and Theory, University of Georgia, Athens, GA, March 29 - April 1, 2022                        
...
\begin{section}{Publications \& Preprints}
%=======================================================
\begin{benumerate}{36}
...
E.G. Charalampidis, D. Mantzavinos, M.E Kavousanakis, P.G. Kevrekidis, and I.G. Kevrekidis
(in preparation)
...
\href{https://arxiv.org/abs/2104.15108}{arXiv:2104.15108} (submitted to PRE)

\item \textbf{\textit{Stability of exact solutions of a nonlocal and nonlinear 
Schr\"odinger equation with arbitrary nonlinearity}}\\
E.G. Charalampidis, F. Cooper, A. Khare, J. Dawson, and A. Saxena \\
\href{https://arxiv.org/abs/2104.14736}{arXiv:2104.14736}  (submitted to JPA)
...
\item The 12th IMACS International Conference on Nonlinear Evolution Equations and Wave Phenomena: Computation and Theory, %
        University of Georgia, Athens, GA, March 29 - April 1, 2022. 
        Talk title: TBA

\item Colloquium, Department of Mathematics, University of Kansas, KS, October 28, 2021.
Talk title: TBA
...
% 
% SIAM Conference on Nonlinear Waves and Coherent Structures, Bremen, Germany, July 27 - 30, 2020.
% Talk title: ``\textit{Existence and stability of peakons in the b-family}''
% 
...
\item Software: Mathematica, MATLAB, Julia, Maple, AUTO software for continuation %
