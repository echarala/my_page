...
% \begin{innerlist}
% %\item[$\triangleright$] ``Undergraduate Research in Applied 
% %Mathematics: Theory, Computation and Algorithms'', amount: $\$389,858$ (submitted)
...
% \end{innerlist}
\item[$\bullet$]
\vskip -7mm California Polytechnic State University, San Luis Obispo
\begin{innerlist} 
\item[$\triangleright$] Scholarly and Creative Activities (RSCA) grant, amount: $\$17,976$, July 2020 - March 2022
\end{innerlist}
\item[$\bullet$]
...
\begin{innerlist} 
\item[$\triangleright$] Organizer of the special session on TBA, The 12th IMACS International Conference on Nonlinear Evolution Equations and Wave Phenomena: 
...
\item[$\triangleright$] Co-organizer (with J. Bramburger and R. Goh) of the Brown/BU/UMass PDE Seminar, since 2018
...
%\item \vskip -4.3mm Department of Mathematics, University of Kansas, KS, May 5 - 8, 2020
\item \vskip -4.3mm Joint visit: Center for Nonlinear Studies, Los Alamos National Laboratory, Los Alamos, NM; 
...
\item \vskip -4.3mm The 12th IMACS International Conference on Nonlinear Evolution Equations and Wave Phenomena: Computation and Theory, %
        University of Georgia, Athens, GA, March 29 - April 1, 2021. 
        Talk title: TBA
...
% 
% \item The 13th AIMS Conference on Dynamical Systems and Differential Equations, Atlanta, GA, June 5 - 9, 2020. 
...
% 
% \item Computational and Applied Mathematics Seminar, Department of Mathematics, University of Kansas, KS, May 6, 2020.
%       Talk title: TBA
