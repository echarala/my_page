...
\begin{innerlist}
\item[$\triangleright$] MATH 143 - Calculus III (F19, W20, S20, F20, W22)
\item[$\triangleright$] MATH 241 - Calculus IV (F21, S22)
\item[$\triangleright$] MATH 344 - Linear Analysis II (S21)
...
\textbf{\textit{The existence and stability of self-similar solutions to the focusing %
Nonlinear Schr\"odinger Equation with a power law nonlinearity}}\\
E.G. Charalampidis, J. Chapman, D. Mantzavinos, M.E. Kavousanakis, P.G. Kevrekidis and I.G. Kevrekidis
(in preparation)

\item \textbf{\textit{Time-periodic solutions in a damped-driven $p$-dimer chain}}\\
...
\href{https://arxiv.org/abs/2110.04693}{arXiv:2110.04693} (submitted to Physica D: Nonlinear Phenomena)
...
\item \textbf{\textit{Stability of trapped solutions of a nonlinear Schr\"odinger %
equation with a nonlocal nonlinear self-interaction potential}}\\
