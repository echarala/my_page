...
amount: $\$122,995$ (submitted)
\end{innerlist}
\item[$\bullet$]
California Polytechnic State University, San Luis Obispo
\begin{innerlist} 
\item[$\triangleright$] Scholarly and Creative Activities (RSCA) grant, amount: $\$17,976$, July 2020 - June 2021
\end{innerlist}
\item[$\bullet$]
...
California Polytechnic State University San Luis Obispo
\begin{innerlist}
\item[$\triangleright$] MATH 143 - Calculus III (Fall 2019, Winter 2020, Spring 2020, Fall 2020)
\item[$\triangleright$] MATH 241 - Calculus IV (Fall 2021)
\item[$\triangleright$] MATH 344 - Linear Analysis II (Spring 2021)
\item[$\triangleright$] MATH 451 - Numerical Analysis I (Winter 2020, Winter 2021)
...
\begin{innerlist}
\item[$\star$] Summer 2020: Marisa Lee, Harry Yan, and Rachel Loh\\
...
\end{innerlist} 
\item[$\bullet$] Referee for scientific journals and books:
\begin{innerlist}
...
\textbf{\textit{Stability of exact solutions of a nonlocal, nonlinear 
Schr\"odinger equation with arbitrary nonlinearity}}\\
E.G. Charalampidis, F. Cooper, A. Khare, J. Dawson, and A. Saxena \\
(in preparation)

\item \textbf{\textit{The existence and stability of self-similar solutions to the focusing %
...
\item \textbf{\textit{Amplitude and frequency dependent scattering of waves in 
reconfigurable bistable chains with impurities}}\\
H. Yasuda, E.G. Charalampidis, P.G. Kevrekidis, P.K. Purohit, and J.R. Raney
(in preparation)
...
\item \vskip -4.3mm 
SIAM Annual Meeting, Spokane, WA, July 19 - 23, 2021. Talk title: 
